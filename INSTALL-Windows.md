...
Note that you can (and should) install the Windows version of postgres even when running tang-core from within WSL.
...
- Open the solution `Builds\VisualStudio\tang-core.sln`
