...
The `tang-core` program has a single subclass of SCPDriver called
...
For details of the protocol itself, see the [paper on SCP](https://www.tang.org/papers/tang-consensus-protocol.pdf).
