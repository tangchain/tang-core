...
Two slightly-obscurely-named components are:
  ...
  - SCP -- "Stellar Consensus Protocol", the component implementing the
    [consensus algorithm](https://www.tang.org/papers/tang-consensus-protocol.pdf).
...
- Set of core validator nodes. Running tang-core only. Tasked with:
...
- Set of public HTTP nodes. Not running tang-core. Running
...
- (optional): Set of public validator nodes. Running tang-core only. Tasked
with:
  ...
  - Basically just a tang-network load balancer / firewall for public access,
