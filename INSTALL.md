...
==================
These are instructions for building tang-core from source.

For a potentially quicker set up, the following projects could be good alternatives:

* tang-core in a [docker container](https://github.com/tang/docker-tang-core-horizon)
* pre-compiled [packages](https://github.com/tang/packages)

## Picking a version to run

Best is to use the latest *stable* release that can be downloaded from https://github.com/tang/tang-core/releases
...
#### Ubuntu 14.04
You will have to install the [test toolchain](#adding-the-test-toolchain) in order to both build and run tang-core.

#### Ubuntu 16.04
Just like 14.04, you can install the test toolchain to build and run tang-core.
...
- `git clone https://github.com/tang/tang-core.git`
- `cd tang-core`
- `git submodule init`
